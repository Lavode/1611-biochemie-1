...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{img/as_struktur.png}
	\caption{AS Struktur}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{img/lipid_klassifikation.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{img/tetraether.png}
	\caption{Tetraether der Archaeen}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{img/membranlipide.png}
